...
define([
	...
	'views/LogIn',
	'views/Todo'
], function ($, _, Parse, JST, Todo, TodoList, state, LogInView, TodoView) {
	// 'use strict';
	...
	var ManageTodosView = Parse.View.extend({
		...
		initialize: function() {
			...
			this.$el.html(_.template(JST['app/scripts/templates/ManageTodos.ejs']()));
		...
		// Logs out the current user and shows the login view
		logOut: function() {
			Parse.User.logOut();
			new LogInView();
